...
import com.example.BusSystem.controller.BusController;
...
@RestControllerAdvice(assignableTypes = {BusController.class})
public class BusExceptionHandler {

    @ExceptionHandler(EntityNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handle404Error() {
        var errorResponse = new ApiErrorResponse("Bus with the specified ID was not found.");

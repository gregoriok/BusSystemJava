...
import com.example.BusSystem.controller.LineStopController;
...
@RestControllerAdvice(assignableTypes = {LineStopController.class})
public class LineStopExceptionHandler {
